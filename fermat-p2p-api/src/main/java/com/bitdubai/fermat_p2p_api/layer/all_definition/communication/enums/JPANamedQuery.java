...
public enum JPANamedQuery implements FermatEnum {
    ...
    GET_ALL_CHECKED_IN_ACTORS_BY_ACTOR_TYPE("ActorCatalog.getAllCheckedInActorsByActorType"),
    GET_ALL_CHECKED_IN_ACTORS("ActorCatalog.getAllCheckedInActors"),
    ...
    IS_NETWORK_SERVICE_ONLINE("NetworkService.isOnline"),
