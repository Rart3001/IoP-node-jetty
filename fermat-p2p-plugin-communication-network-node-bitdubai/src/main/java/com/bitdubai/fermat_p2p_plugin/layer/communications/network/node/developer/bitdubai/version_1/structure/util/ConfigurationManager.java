...
import com.bitdubai.fermat_p2p_plugin.layer.communications.network.node.developer.bitdubai.version_1.structure.JettyEmbeddedAppServer;
...
public class ConfigurationManager {
    ...
    public static void create(String identityPublicKey) throws IOException, ConfigurationException {
        ...
        newConfigurationFile.addProperty(INTERNAL_IP, JettyEmbeddedAppServer.DEFAULT_IP);

        newConfigurationFile.getLayout().setComment(PUBLIC_IP, "\n# * SERVER PUBLIC IP (Configure 0.0.0.0 by default)");
        newConfigurationFile.addProperty(PUBLIC_IP, JettyEmbeddedAppServer.DEFAULT_IP);
